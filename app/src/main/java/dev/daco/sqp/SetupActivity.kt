...
import dev.daco.sqp.kiosk.SetupFormError
import dev.daco.sqp.kiosk.SetupFormResult
import dev.daco.sqp.kiosk.SetupFormValidator
...
class SetupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        urlInput.setText(settings.homeUrl ?: DEFAULT_URL)
    ...
    companion object {
        ...
        /** 初回設定時にあらかじめ入れておく URL。 */
        const val DEFAULT_URL = "https://sqp.sub.daco.dev"
